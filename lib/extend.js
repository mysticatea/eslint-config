...
module.exports = function() {
    ...
    for (var i = 0, end = arguments.length; i < end; ++i) {
        ...
        // parserOptions
        if (source.parserOptions != null) {
            if (retv.parserOptions == null) {
                retv.parserOptions = {};
            }
            if (source.parserOptions.ecmaVersion != null) {
                retv.parserOptions.ecmaVersion = source.parserOptions.ecmaVersion;
            }
            if (source.parserOptions.sourceType != null) {
                retv.parserOptions.sourceType = source.parserOptions.sourceType;
            }
            if (source.parserOptions.ecmaFeatures != null) {
                retv.parserOptions.ecmaFeatures = assign(retv.parserOptions.ecmaFeatures || {}, source.parserOptions.ecmaFeatures);
            }
        }
